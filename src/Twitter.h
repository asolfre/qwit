...
signals:
	...
	void friendshipCreated(const QByteArray &);
	void friendshipDestroyed(const QByteArray &);
	void blockCreated(const QByteArray &);
	void blockDestroyed(const QByteArray &);
